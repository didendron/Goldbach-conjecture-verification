...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        if (!(number.mod(BigInteger.valueOf(2))).equals(BigInteger.valueOf(0))){
            ...
            for(BigInteger i=BigInteger.valueOf(3);i.compareTo(number.subtract(BigInteger.valueOf(3)))<=0;i=i.add(BigInteger.valueOf(2))){
                System.out.println(i);
                if((isPrime(i))&&(isPrime(number.subtract(i)))){
                    firstAddend=i;
                    secondAddend=number.subtract(i);
                    break;
                }
            }
